...
echo "  • build.sh       - Build script (pip, collectstatic, migrate, load demo data)"
...
echo ""
echo "🔐 Admin Credentials (auto-created in build.sh):"
echo "  • ADMIN_USER (username, default: admin)"
echo "  • ADMIN_EMAIL (email, default: admin@primefit.com)"
